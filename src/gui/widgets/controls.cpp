...
ControlsWidget::Event ControlsWidget::render(const LoopbackStats& stats, ModemConfig& config,
    ...
    // Theoretical max throughput for negotiated mode
    ...
    // Speed is automatically adapted based on channel conditions
    ImGui::Spacing();
    ImGui::TextColored(ImVec4(0.3f, 0.9f, 1.0f, 1.0f), "Speed: Adaptive");
