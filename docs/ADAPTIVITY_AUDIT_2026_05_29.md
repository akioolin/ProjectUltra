...
| Rate / modulation picker | `waveform_selection.hpp`, `connection_policy.hpp` | ⬜ | Known scar tissue (4 gate-arrays × 3 passes); QAM8 was unhandled → AWGN fallthrough. Channel-adaptive promotion is the matching workstream. |
