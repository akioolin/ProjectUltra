...
int main() {
    ...
    packet.header.flags = kOtaAudioFlagTxStateValid | kOtaAudioFlagTxActive;
    ...
    assert((parsed->header.flags & kOtaAudioFlagTxStateValid) != 0);
    assert((parsed->header.flags & kOtaAudioFlagTxActive) != 0);
